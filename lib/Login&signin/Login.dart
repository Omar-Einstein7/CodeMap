...
class _loginState extends State<login> {
  ...
  Widget build(BuildContext context) {
    ...
    var Formkey=GlobalKey<FormState>();                  // use to show error if you don't Write Username or passwoed

    var EmailController= TextEditingController();        //Select text inside Username or Email Address Field

    var PasswordController= TextEditingController();     //Select text inside Password Field
                  ...
                  children: [
                      ...
                      child: Transform.scale(scale: 1.8,           //Size Circle out body
                        child: Container(
                            child:  ClipRect(
                              child: CircleAvatar(
                                radius: 120,                       // Size Circle
                                backgroundColor: Colors.white.withOpacity(0.5),         //Color Circle
                              ),
                            )
                        ),
                      ),
                    ...
                    SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        mainAxisAlignment: MainAxisAlignment.center,//use to make (Word "Login" & Username or EmailAddress Field & The Password field & LoginButton & ("Dont Have An Account? & Registry") & ("Forget Your Password") In The Middle

                        children:[


                          TitlePage(FTITLE: "Login",fontsize: 65,height:4
                          ),                //  This is Word "Login"
                          ...
                          PASSWORDFIELD(
                            ...
                            suffix: GestureDetector(
                              ...
                              child: Icon(_obsecureTxt ? Icons.visibility : Icons.visibility_off, color: Colors.white54),
                            ),
                          ),
